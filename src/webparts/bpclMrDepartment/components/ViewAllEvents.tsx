    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.banner}>
        ...
        <div>
          <h3>Events</h3>
          <p>
            Discover upcoming events, workshops, meetings, celebrations, and
            activities happening across the organization.
          </p>
        </div>
      </div>
      ...
      <div className={styles.cardContainer}>
        ...
        <Row className="gx-3">
          {pagedEvents.length === 0 ? (
            <div className="text-center py-5">No Events Found</div>
          ) : (
...
{/* <img
  ...
  />                      */}
                    ...
                    <h5 className={styles.eventTitle}>{card.Title}</h5>

                    <div className={styles.eventDateRow}>
                      <i className="bi bi-calendar-event"></i>

                      <span className={styles.dateText}>
                        <strong>{start.toLocaleDateString("en-GB")}</strong>
